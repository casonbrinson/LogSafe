...
//  MyPIM
//
//  Created by Gregory Cason Brinson on 10/13/20.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //getPermissionForLocation()      //CurrentLocation.swift is where all of these are
        //getPermissionForSpeechRecognition() //in SpeechRecognizer.swift
        //getPermissionForVoiceRecording()    //in NotesData.swift
        
        //read the data to use for the app
        //readNotesDataFiles()
        //readToDoDataFiles()
        //readContactDataFiles()
